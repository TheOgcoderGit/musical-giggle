...
async def _process_expired_plans(bot):
    ...
    for row in rows:
        ...
        try:
            ...
            if row["auto_renew"] and row["last_purchase_plan"] and row["last_purchase_months"]:
            ...
            if not renewed:
                ...
                reason = (
                    "your wallet balance was insufficient for auto-renewal"
                    if row["auto_renew"]
                    else "it wasn't set to auto-renew"
                )
