...
`ChannelFlowAI5_FinalProduction_BUILD_FIXED_v4.zip` plus the
requirements established during the ChannelFlow project conversations.\
...
Telegram sends OTP
        |
        v
Bot asks user to send /mycode<OTP>
        |
        v
User sends /mycode94563
        |
        v
Extract OTP
        |
...
The required command is `/mycode`.
